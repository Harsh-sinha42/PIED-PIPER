    ...
    <div className="min-h-screen bg-background relative">
        ...
        >
          <div className="bg-accent/50 rounded-2xl p-8 mb-8">
            <h1 className="text-6xl font-bold text-foreground">
              Hey, I'm <span className="text-primary">HARSH SINHA</span>
            </h1>
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a
            href="https://github.com/Harsh-sinha42"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/harsh-sinha-b9a691256/"
            target="_blank"
          ...
          <a
            href="mailto:harshksinha09012005@gmail.com"
